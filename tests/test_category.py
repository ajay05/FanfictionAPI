...
class TestCategory(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.category_src = open('tests/categories/category.html', 'r').read()
        ...
        self.single_page_src = open('tests/categories/single_page_category.html', 'r')
        ...
        self.double_page_src = open('tests/categories/double_page_category.html', 'r')
    ...
    def test_get_author(self):
        self.category_list = categorylisting.CategoryListing('https://www.fanfiction.net/game/Lego/')
        self.assertIsInstance(next(self.category_list.get_author()), Author, 'Correct type returned')
        self.category_list = categorylisting.CategoryListing('https://www.fanfiction.net/game/Double-Dragon/')
        self.assertIsInstance(next(self.category_list.get_author()), Author, 'Correct type returned')
