...
class TestAuthor(unittest.TestCase):
  ...
  def test_get_fanfics(self):  
    ...
    self.assertTrue(expected, self.author.get_fanfics())
  ...
  def test_get_favorite_fanfics(self):  
    ...
    self.assertTrue(expected, self.author.get_favorite_fanfics())
  ...
  def test_get_favorite_authors(self):  
    ...
    self.assertTrue(expected, self.author.get_favorite_authors())
